...
public class EmployeeService {
    ...
    private EmployeeDto employeeConverter(Employee employee) {
        ...
        LOGGER.info("EmployeeDto object: {}",employeeDto);
        LOGGER.info("EmployeeDto hashcode: {}",employeeDto.hashCode());
        LOGGER.info("EmployeeDto equals: {}",employeeDto.equals(employeeDto));
        LOGGER.info("EmployeeDto firstName: {}",employeeDto.firstName());
        return employeeDto;
    }
