...
public class LombokDemoApplication {
	...
	public CommandLineRunner mappingDemo(EmployeeRepository employeeRepository,
		...
		return args -> {
			...
			final Employee.EmployeeBuilder builder = Employee.builder();
			...
			Employee franklinEmployee = new Employee(null, "Franklin", "Benjamin",
					"Paul", "Sr", "bpr@gmail.com",null, null, EmployeeStatus.FULLTIME, new Date());
