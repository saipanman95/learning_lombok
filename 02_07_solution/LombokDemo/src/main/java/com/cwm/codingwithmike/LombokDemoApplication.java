...
public class LombokDemoApplication {
	...
	public CommandLineRunner mappingDemo(EmployeeRepository employeeRepository,
		...
		return args -> {
			...
			Employee.EmployeeBuilder builder2 = Employee.builder();
			Employee franklinEmployee = builder
					.firstName("Benjamin")
					.lastName("Franklin")
					.middleName("Paul")
					.suffix("Sr")
			...
			final Address.AddressBuilder addBuilder = Address.builder();
			Address franklinAddress = addBuilder
					...
					.zipCode("02109")
					.build();
			final Address.AddressBuilder addBuilder2 = Address.builder();
			Address theodoreAddress = addBuilder
					.employee(franklinEmployee)
