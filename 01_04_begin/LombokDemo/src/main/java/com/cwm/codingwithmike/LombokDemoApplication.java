...
public class LombokDemoApplication {
	...
	public CommandLineRunner mappingDemo(EmployeeRepository employeeRepository,
		...
		return args -> {
			Employee theodoreEmployee = new Employee("Roosevelt", "Theodore", "Cleveland", "Jr", new Date());
			Employee franklinEmployee = new Employee("Franklin", "Benjamin", "Paul", "Sr", new Date());
			employeeRepository.save(theodoreEmployee);
			employeeRepository.save(franklinEmployee);

			Address franklinAddress = new Address(franklinEmployee, "home",
					"618033 Milk Street", null, "Boston", "MA", "02109", new Date());
			Address theodoreAddress = new Address(theodoreEmployee, "home",
